...
describe('Dec 4', () => {
  ...
  describe('Part 2', () => {
    it('can calculate the correct score for the loosing board for the sample data', () => {
      expect(calculateLoosingGameScore(sampleData)).toBe(1924)
    })
  })
})
